...
export function Orb({
  ...
  useEffect(() => {
    ...
    image.src = "https://storage.googleapis.com/eleven-public-cdn/images/perlin-noise.png"
    image.onload = () => {
      gl.bindTexture(gl.TEXTURE_2D, texture)
    ...
    const render = (time: number) => {
      ...
      gl.uniform1f(uniforms.uInverted, isDark ? 1 : 0)
      gl.uniform3f(uniforms.uColor1, currentColor1[0], currentColor1[1], currentColor1[2])
      gl.uniform3f(uniforms.uColor2, currentColor2[0], currentColor2[1], currentColor2[2])
      ...
      gl.bindTexture(gl.TEXTURE_2D, texture)
      gl.uniform1i(uniforms.uPerlinTexture, 0)
